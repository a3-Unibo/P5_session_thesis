/*
bug solved: pg.clear() should be called in between pg.beginDraw() and pg.endDraw()
 */
...
void setup() {
  ...
  surface.setSize(displayWidth-20,displayHeight-50); // resize after
  //surface.setResizable(true); // if you want the sketch window to be resizable
  // smooth(); // no need for it since it was enabled by default in Processing 2.0
